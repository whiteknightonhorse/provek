    ...
    <header className="bg-[var(--color-paper)] border-b border-[var(--color-line)]">
      <div className="mx-auto max-w-[1180px] px-5">
        <div className="flex items-center justify-between py-3">
          ...
          <a href="#/apply" className="text-sm border border-[var(--color-line-2)] px-3 py-1.5 hover:bg-[var(--color-paper-2)]">
        ...
        <nav className="flex gap-1 border-t border-[var(--color-line)] pt-1" aria-label="Main">
          ...
          <span
            className="px-3 py-2 text-sm text-[var(--color-line-2)] cursor-default select-none"
            aria-disabled="true"
            title="Not available"
          >
            Corpus
...
export function Strip({
  ...
  return (
    <div
      className="border-l-[3px] bg-[var(--color-paper)] px-4 py-2.5 text-sm border-y border-r border-[var(--color-line)]"
